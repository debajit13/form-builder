                      ...
                      <tr key={form.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            ...
                            {form.description && (
                              <div className="text-sm text-gray-500 max-w-xs truncate">{form.description}</div>
                            )}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center space-x-2">
                <label htmlFor="form-filter" className="text-sm font-medium text-gray-700">
                  Filter by form:
                </label>
                <select
                  id="form-filter"
      ...
      {viewMode === 'analytics' && analytics && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Submissions by Form</h3>
