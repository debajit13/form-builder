      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            ...
            <p className="text-gray-600">Built-in validation with Zod and React Hook Form for instant feedback.</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            ...
            <p className="text-gray-600">Show or hide fields based on user input with dynamic conditional rules.</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Multi-step Forms</h3>
            <p className="text-gray-600">Break complex forms into manageable steps with progress tracking.</p>
          </div>
        </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm border">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h3 className="text-md font-medium text-gray-900 mb-3">JSON Schema Input</h3>
    ...
    "fields": [{
      ...
      "validation": {
        ...
        "minLength": 2
              ...
              <div>
                <h3 className="text-md font-medium text-gray-900 mb-3">Generated Form</h3>
                <div className="bg-gray-50 rounded-lg p-4 h-64 flex items-center justify-center">
                  <div className="text-center">
                    <svg className="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <p className="text-gray-600">Interactive form with validation</p>
                    <p className="text-sm text-gray-500">Click on a sample form above to see it in action</p>
                  </div>
                </div>
              </div>
            </div>
