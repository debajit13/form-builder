        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navigation.map((item) => (
              ...
              >
                <span className={`transition-colors ${isActive(item.href) ? 'text-blue-600' : 'text-gray-500 group-hover:text-blue-600'}`}>
                  {item.icon}
                </span>
                <span>{item.name}</span>
              </Link>
          ...
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="space-y-1">
              {navigation.map((item) => (
                ...
                >
                  <span className={`transition-colors ${isActive(item.href) ? 'text-blue-600' : 'text-gray-500'}`}>
                    {item.icon}
                  </span>
                  <div>
                    <div>{item.name}</div>
